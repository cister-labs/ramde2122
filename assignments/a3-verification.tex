...
\end{itemize}
Provide two variations of this system and include them in a \bash{vending.mcrl2} file, according to the requirements below. Try to keep the specifications simple. \textbf{Submit this file in your git repository.}
