...
\title{A2: Analysing behaviour -- Part I}
...
\descrbox{What to submit}{
 The PDF report and a new \bash{vending.mcrl2} file (for Exercise~\ref{ex:vm}), placed in your group's git repository. Recall that \textbf{all students should push commits}.
}

\descrbox{Deadline:}{
  9 Dec 2022 @ 23:59 (Monday) -- together with Part II (to appear)
}
...
\begin{quote}\it
  ...
  The machine can hold at most 100 coins of 1€ and 100 coins of 2€. 
  If the machine has no 1€ coins, it cannot not sell fruit with a 2€ coin. 
  If the machine has already 2€ inserted, it cannot collect another coin.
  The machine should give change back when buying fruit after inserting 2€.
  The user can cancel its request and get the money back.
\end{quote}
\end{myExercise}
