...
\myparagraph{To submit:} The PDF report and the 3 files requested in the exercises: \bash{farmer1.mcrl2}, \bash{farmer2.mcrl2} and \bash{farmer3.mcrl}. All files should be in your group's git repository. ALL students should push commits.
...
Start by downloading the auxiliary files for this assignment at \url{https://cister-labs.github.io/ramde2122/assignment/farmer.zip}, where you will find the \bash{farmer1.mcrl2} file above.
