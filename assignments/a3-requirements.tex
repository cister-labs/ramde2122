...
\subex{\label{ex:f1}
  ...
  If you are able to identify new requirements or aspects that were not explicit in the explanations of the assignments, \textbf{list them and explain them}.
}
...
\subex{\label{ex:f2}
  ...
  \\[2mm]
  Include both the Doorstop requirements and the html documentation in your group's git repository, merged with the ones produced in Exercise~\ref{ex:vm3}.
}
