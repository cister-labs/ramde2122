...
\subex{\label{ex:vm1}
   \textbf{Rewrite the requirements} above as a set of requirements following the EARS patterns.
}
...
\subex{\label{ex:f2}
  ...
  Generate the \textbf{html documentation} together with the result from Exercise~\ref{ex:vm3}.
  \\[2mm]
  Include both the Doorstop requirements and the html documentation in your group's git repository.
}
