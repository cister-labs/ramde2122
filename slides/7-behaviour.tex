...
\begin{slide}{Sequence Diagrams as Interactive Processes}
  ...
  \col[0.4]{
    \begin{exampleblock}{\exercise  Write an interactive processes that act the seq. diagram.}
...
\begin{slide}{Sequence Diagrams as Interactive Processes}
  ...
  \col[0.4]{
    \begin{exampleblock}{\exercise  Write a single process $Sys_{global}$ and a set of interactive processes $Sys_{local}$ that act the seq. diagram.}
