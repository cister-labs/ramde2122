...
\begin{slide}{Quick exercise}
  ...
  \begin{columns}
    ...
    \begin{column}{0.50\textwidth}
      ...
      \fa \color{green}{(\varphi \land \theta) \lor (\psi \land \theta)} & \disje{2}{4{-}6}{7{-}9}
      \end{fitch}
    \end{column}  
  \end{columns}
...
\begin{center}
      ...
      \fa \fa \varphi \lor \psi & \disjil{2} \\
      \fa \fa \theta & \impe{1}{4} \\
      \fa \color{green}{\psi \to \theta} & \impi{3}{5}
      \end{fitch}
\end{center}
\end{slide}
