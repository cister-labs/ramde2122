...
\newcommand{\mkw}[3]{\textcolor{#2}{\textbf{#1}\xspace#3}\xspace}
\newcommand{\ewhile}[1][]{\mkw{while}{orange!85!black}{#1}}
% \newcommand{\ewhile}{\mkw{while}{pink!75!black}}
\newcommand{\ewhere}[1][]{\mkw{where}{pink!65!black}{#1}}
\newcommand{\eif}[1][]{\mkw{if}{pink!65!black}{#1}}
\newcommand{\ethen}[1][]{\mkw{then}{pink!75!black}{#1}}
\newcommand{\ewhen}[1][]{\mkw{when}{purple!65!black}{#1}}
\newcommand{\ethe}[1][]{\mkw{the}{red!75!black}{#1}}
\newcommand{\eshall}[1][]{\mkw{shall}{blue!75!black}{#1}}
...
\begin{slide}{Ubiquitous requirements}
  ...
  \begin{example}
    \begin{itemize}
      \item \ethe[mobile phone] \eshall[have a mass of less than $x$ grams].
...
\begin{slide}{State driven requirements}
  ...
  \begin{itemize}
    ...
    \item \ewhile[in maintenance mode], \ethe[kitchen system] \eshall[reject all input].
  \end{itemize}
  \end{example}
