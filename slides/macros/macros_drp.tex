...
\newcommand{\setLecture}[2]{\setcounter{lectureID}{#1}
  ...
  \institute{CISTER -- ISEP \\ Porto, Portugal \flushright\url{https://cister-labs.github.io/ramde2122}}
  \date{RAMDE 2021/2022\\Requirements and Model-driven Engineering}
...
\newcommand{\newExercise}[3][0mm]{\begin{exampleblock}{Exercise}\wrap{\rule{0pt}{#1}}#3\end{exampleblock}}
