...
\setLecture{8}{Behavioural equivalences}
...
\begin{slide}{Exercise}
\doExercise{Find a simulation between $SmUni$ and $SmUni'$}{
  \vspace*{-10mm}
  \begin{columns}
  \col[0.35]{    
    \begin{align*}
    ...
    \begin{align*}
      ...
      % \\
      % CS &= \mathsf{pub.(coin.coffee.CS + coin.tea.CS)}
      CM' &= \mathsf{coin.(\ainv{coffee}}.CM' + \mathsf{coin.\ainv{latte}}.CM')
      \\
      CS' &= \mathsf{pub.\ainv{coin}.(coffee}.CS' + \mathsf{\ainv{coin}.latte}.CS')
      \\
      SmUni' &= \crt{(CM'|CS')}{\mathsf{\set{coin,coffee,latte}}}
    \end{align*}  
  }
  \end{columns}
  % \vspace*{-7mm}
...
% \text{\structure{(1)}}\; \;  & p \rtran{\tau}_1 p'\; \imp\;
  % \rcb{\exists}{q'}{q' \in S_2}{\rdb{q \Trans{tau}_2  q'}\, \e\,
  % \pair{p',q'} \in R}   \\
\text{\structure{(1)}}\; \;  & p \rtran{a}_1 p'\; \imp\;
  \rcb{\exists}{q'}{q' \in S_2}{\rdb{q \Trans{a}_2  q'}\, \e\,
  \pair{p',q'} \in R}   \\
% \text{\structure{(3) and (4)}}\; \;  & \text{symmetric case for }q\rtran{~}_2 q'
...
\begin{slide}{Exercise}
\doExercise{Search for a bisimulation, a weak bisimulation, and a branching bisimulation between $SmUni$ and $SmUni''$}{
  \vspace*{-10mm}
  \begin{columns}
  \col[0.45]{    
    \begin{align*}
    ...
    \begin{align*}
      ...
      % \\
      % CS &= \mathsf{pub.(coin.coffee.CS + coin.tea.CS)}
      CM'' &= \mathsf{coin.(sel.\ainv{coffee}}.CM'' + \\&~~~~~~~\mathsf{coin.sel.\ainv{latte}}.CM'')
      \\
      CS'' &= \mathsf{pub.\ainv{coin}.\ainv{sel}.coffee}.CS''
      \\
      \!\!\!\!\!\!%
      SmUni'' &= \crt{(CM''|CS'')}{\mathsf{\set{coin,coffee,latte,sel}}}
    \end{align*}  
  }
  \end{columns}
  % \vspace*{-7mm}
...
\begin{slide}{Are words enough?} \centering
  ...
  \doExercise{Let $sd$ be the diagram above and recall Slide~\ref{slide:sd as proc}}{
    Does $Sys_{local}$ still includes $sd$ if $U$ is instead defined as below? 
    \begin{enumerate}
      % \item Your process from Slide~\ref{slide:sd as proc} \alert{covers} $sd$?
      \item $U = \ainv{insertCard}.{ejectCard}.\cnil + \ainv{insertCard}.\cnil$
      \item $U = (\ainv{insertCard}.{ejectCard}.\cnil) + \ainv{goAway}.\cnil)$
